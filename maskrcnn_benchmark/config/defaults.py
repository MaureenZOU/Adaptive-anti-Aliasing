...
_C.MODEL.BLUR_DOWN = ""
_C.MODEL.PASA_GROUP = 1
_C.MODEL.PASA_FILTER = 1
_C.MODEL.BLUR_DOWN = ""
...
_C.SOLVER.TEST_CHECKPOINT_PERIOD = 20000
_C.SOLVER.TEST_IN_TRAIN = False
...
# This is global, so if we have 8 GPUs and IMS_PER_BATCH = 16, each GPU will
# see 2 images per batch
_C.TEST.INFERENCE_TYPE = 'map_coco' # 'map_yolact', 'map_coco', 'pmk_yolact'
