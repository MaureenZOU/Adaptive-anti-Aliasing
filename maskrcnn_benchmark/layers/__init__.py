...
from .downsample import Downsample, Downsample_PASA_group_softmax
from .learn_downsample import Downsample_LS, Downsample_Spa, Downsample_PASA
from .conv_down import Conv2d_Down, MaxPool_Down
